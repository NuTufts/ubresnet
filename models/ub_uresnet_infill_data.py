...
class UResNetInfillData(nn.Module):
    ...
    def __init__(self, num_classes=1, input_channels=3, inplanes=16, final_conv_kernels=16, showsizes=False):
        ...
        # stem
        # one big stem
        self.pad =  nn.ConstantPad1d(8, 0)
        self.unpad =  nn.ConstantPad1d(-8, 0)
    ...
    def forward(self, x):
        ...
        if self._showsizes:
            print "after padding",x.size()," is_cuda=",x.is_cuda
