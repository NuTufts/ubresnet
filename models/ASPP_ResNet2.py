...
# Encoder blocks 3, 4, & 5 have ASPP with backbone concatenation
...
class ASPP_ResNet(nn.Module):
    ...
    def __init__(self, num_classes=3, in_channels=3, inplanes=16, showsizes=True):
        ...
        self.ASPP_combine_enc3 = self.ASPP_combine(self.inplanes * 12, self.inplanes * 8)
        ...
        self.dec_layer4 = self._make_decoding_layer(self.inplanes * 32, self.inplanes * 8, self.inplanes * 16)  # 256->128
        self.dec_layer3 = self._make_decoding_layer(self.inplanes * 16, self.inplanes * 4, self.inplanes * 4)  # 128->64
